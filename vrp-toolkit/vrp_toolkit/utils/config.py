"""
Configuration management for VRP Toolkit.
...
@dataclass
class VRPConfig:
    """Main configuration container for VRP Toolkit."""
    ...
    description: str = "VRP Toolkit Configuration"
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> 'VRPConfig':
        ...
        return cls(
            ...
            description=config_dict.get('description', 'VRP Toolkit Configuration')
        )
