# VRP-Toolkit Playground

Interactive Streamlit web interface for learning VRP-Toolkit through hands-on exploration.
...
```bash
# From project root
cd E:\Code\Github\VRP-heuristics
...
The playground connects to VRP-Toolkit as follows:
...
### Import errors
```bash
# Make sure vrp-toolkit is installed
cd vrp-toolkit
uv pip install -e .
```
